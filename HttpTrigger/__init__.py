...
mail_subject = 'AOAI Demonstration'
...
def chat_gpt(input_txt: str) -> str:
    response = openai.ChatCompletion.create(
        engine="gpt-35-turbo",
        messages = [
            {"role":"system","content":"英語の文章を日本語に要約して返答を行ってください。\n構文の特徴は以下の通りです。\n- 日本語で回答\n- 絵文字は使わない\n- 100文字を絶対に超えてはいけない"},
            ...
            {"role":"assistant","content":"日本の自治体がOpenAIが開発したAIチャットボットChatGPTを採用しています。東京の南に位置する横須賀市は、全事務所でこの言語モデルを実験的に初めて導入しました。"},
